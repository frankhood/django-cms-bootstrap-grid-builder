...
coverage: ## check code coverage quickly with the default Python
	coverage run --source bootstrap_grid_builder runtests.py tests
	coverage report -m
	coverage html
	open htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/django-cms-bootstrap-grid-builder.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ bootstrap_grid_builder
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
